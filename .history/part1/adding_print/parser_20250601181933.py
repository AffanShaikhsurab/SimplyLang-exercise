...
class Praser:
    ...
    def term(self):
        return self.factor()  # Simplified since we only need to handle strings    def skip_newlines(self, res):
    ...
    def expr(self, seen=False):
        ...
        if self.current_token is not None and self.current_token.type == lexer.TT_KEYWORD and self.current_token.value == "show":
            ...
            if self.current_token is not None and self.current_token.type != lexer.TT_LP:
            ...
            while self.current_token is not None and self.current_token.type != lexer.TT_RP:
                ...
                if self.current_token is not None and self.current_token.type == lexer.TT_RP:
                    break
