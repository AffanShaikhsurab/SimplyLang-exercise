...
class Parser:
    ...
    def expr(self, seen=False):
        ...
        if not seen and self.current_token.type == lexer.TT_IDENTIFIER:
            ...
            if self.current_token is None or self.current_token.type != lexer.TT_KEYWORD or self.current_token.value != "is":
            ...
            if self.current_token is not None and self.current_token.type in (lexer.TT_STRING, lexer.TT_NUMBER):
                ...
                # Store variable in our tracking list
                self.variables.append(variable_token.value)
                print(f"Variable created: {variable_token.value} with complex expression")
