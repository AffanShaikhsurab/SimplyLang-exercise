...
class TillNode:
    def __init__(self, condition_expr, body):
        ...
        self.pos_start = getattr(self.condition_expr, 'pos_start', getattr(self.condition_expr, 'start', None))
        if self.body and hasattr(self.body[-1], 'pos_end'):
            ...
            self.pos_end = getattr(self.condition_expr, 'pos_end', getattr(self.condition_expr, 'end', None))
...
class NumberNode:
    def __init__(self, value):
        self.value = value
        self.pos_start = self.value.start
        self.pos_end = self.value.end
...
class VariableNode:
    def __init__(self, varible_name, value_node):
        ...
        self.pos_end = self.value_node.end
