...
def build_pdf():
    ...
    try:
        ...
        map_placeholder = PlaceholderImage(4*inch, 3*inch, bgColor=HexColor("#EFF5FB"))
        map_caption = Paragraph("<i>Explore Karnataka's most scenic locations</i>", styles["CaptionText"])
        
        map_table = Table(
            [[map_text], [map_placeholder], [map_caption]],
            colWidths=[doc.width]
        )
