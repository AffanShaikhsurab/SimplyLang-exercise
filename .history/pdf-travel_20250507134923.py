...
def cover_page(canvas, doc):
    ...
    try:
        ...
        response = requests.get(IMAGES["cover_image"], stream=True, timeout=10, headers=headers)
        response.raise_for_status()
        ...
        canvas.drawImage(temp_path, 0, 0, width=A4[0], height=A4[1], preserveAspectRatio=False)
